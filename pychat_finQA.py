...
session = ChatGPT(session_token)
#try :
i = 0
with open("FinQA_processed.csv") as questions :
    reader = csv.reader(questions)
    next(reader, None)        
    for question in reader :
        if i == 1 :
            break
        print("Given the following information, \"" + question[0] + "\" " + question[1])
        print()
        print("=" * 20)
        print()
        message = "Given the following information, \"" + question[0] + "\" " + question[1]
